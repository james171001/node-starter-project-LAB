        ...
        if (!SequelizeConnection.instance) {
            SequelizeConnection.instance = new sequelize_1.Sequelize(environment_1.default.DB_SCHEMA, environment_1.default.DB_USERNAME, environment_1.default.DB_PASSWORD, {
                ...
                pool: {
                    ...
                    max: 20,
                    acquire: 30000,
                    idle: 10000, // waits if idle for 10 seconds before refreshing pool
                },
    ...
    static connect() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                logger_1.default.error('Error while creation connection to the database :: ' +
                    err.message);
                return sequelize;
            }
        });
    ...
    static close() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                logger_1.default.error('Error while closing the database connection :: ' + err.message);
                return sequelize;
            }
        });
    }
